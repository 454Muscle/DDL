...
export default function ResetPasswordPage() {
    ...
    return (
        <div className="container" style={{ maxWidth: 520, padding: '2rem 1rem' }}>
            <h1 className="pixel-font" style={{ fontSize: '0.875rem', marginBottom: '1rem' }}>RESET PASSWORD</h1>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <button className="submit-btn" type="submit" disabled={loading} data-testid="reset-submit-btn">
